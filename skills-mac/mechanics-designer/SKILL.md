...
description: Generates core gameplay mechanics for a game concept
---
Return exactly this format and nothing else:
1. [one sentence mechanic]
2. [one sentence mechanic]
3. [one sentence mechanic]
4. [one sentence mechanic]
5. [one sentence mechanic]

No intro. No explanation. No extra text. Stop after line 5.
